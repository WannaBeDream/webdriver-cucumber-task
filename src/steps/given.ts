...
import goToPreviusPage from '../support/action/goToPreviusPage';
import printTextElementToConsole from '../support/action/printTextElementToConsole';
...
Given(
    /^I go to previus page$/,
    goToPreviusPage
);

Given(
    /^Print text of "([^"]*)?" to console$/,
    printTextElementToConsole
);